from settings import log_path_check_service_backend
import subprocess
import traceback
import logging
import threading
...
logging.basicConfig(
    ...
    filename=log_path_check_service_backend  # Log events to a file named 'check_service.log'
)
...
if __name__ == "__main__":
    ...
    services_to_manage = ["compute-layer-functions-api","live-data"]  # Example service list
